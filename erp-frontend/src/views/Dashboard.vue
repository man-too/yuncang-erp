...
const statCards = ref([
  { title: '供应商数量', value: 0, icon: 'Truck', color: '#005BF5' },
  { title: '产品数量', value: 0, icon: 'Box', color: '#00941E' },
  { title: '采购订单', value: 0, icon: 'ShoppingCart', color: '#F27A00' },
  { title: 'AI 建议', value: 0, icon: 'MagicStick', color: '#E52E2E' },
])
